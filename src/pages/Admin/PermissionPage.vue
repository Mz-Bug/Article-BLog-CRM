<template>
  <q-page class="q-pa-lg">
    <q-card>
      <q-table title="Permissions" :rows="store.Permissions" :hide-header="mode === 'grid'" :columns="columns"
        row-key="name" :grid="mode == 'grid'" :filter="filter" :pagination="initialPagination" class="q-pa-md"
            ...
            <q-list>
              <q-item>
                <q-item-section>
                  ...
                  <q-input dense outlined v-model="fname" placeholder="Enter User Permission" :rules="[
                    (val) =>
              ...
              <q-item class="q-pt-none">
                <q-item-section>
                  <q-item-label class="q-pb-sm">Permission Description</q-item-label>
                  <q-input dense outlined v-model="lname" placeholder="Enter Permission Description" :rules="[
                    (val) =>
                      (val && val.length > 0) || 'This field is required',
                  ]" />
                </q-item-section>
